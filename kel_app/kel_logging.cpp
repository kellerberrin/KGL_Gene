...
// Uncomment to use spdlog library for logging. This option may be removed at some future time.
//#define SPD_LOGGINGIMPL 1
#ifdef SPD_LOGGINGIMPL

#include "kel_logging_spd.h"

namespace kellerberrin {   //  organization level namespace

class ExecEnvLoggerImpl : public SPDLoggerImpl {

public:

  ExecEnvLoggerImpl(const std::string &module, const std::string &log_file) : SPDLoggerImpl(module, log_file) {}
...
class ExecEnvLoggerImpl : public StreamLoggerImpl {

public:

  ExecEnvLoggerImpl  (const std::string &module, const std::string &log_file) : StreamLoggerImpl(module, log_file) {}
  ~ExecEnvLoggerImpl() = default;
