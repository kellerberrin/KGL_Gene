...
private:
  ...
  static constexpr std::string ANSI_YELLOW = "\033[1;33m";
  static constexpr std::string ANSI_RED = "\033[1;31m";
  static constexpr std::string ANSI_BACKGROUND_RED = "\033[1;41m";
  static constexpr std::string ANSI_RESET = "\033[0m";

  static constexpr std::string INFO = "[INFO] ";
  static constexpr std::string WARN = "[WARN] ";
  static constexpr std::string ERROR = "[ERROR] ";
  static constexpr std::string CRITICAL = "[CRITICAL] ";
