...
// Translation table registry and index constants.
// A namespace of constexpr data: the previous class form was a fake singleton (deleted ctors, all static members).
namespace Tables {

  inline constexpr int CODING_NUCLEOTIDE_2 = 4;
  inline constexpr int CODING_NUCLEOTIDE_1 = 16;
  inline constexpr int AMINO_TABLE_SIZE = 64;
