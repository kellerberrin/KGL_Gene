...
public:
  ...
  DNA5SequenceCoding(const DNA5SequenceCoding& copy) = delete; // For Performance reasons, no copy constructor.
  ~DNA5SequenceCoding() override = default;

  // For Performance reasons, don't allow naive assignments.
  DNA5SequenceCoding& operator=(const DNA5SequenceCoding& copy) = delete;
...
public:
  ...
  /// Letter offset is the relative sequence offset.
