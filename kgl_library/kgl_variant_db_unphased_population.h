...
public:
  ...
  // The second integer is the number of unique variants added to the population.
  // There can be multiple unique variants per contig offset.
  ...
  // Processes all variants in the population with class Obj and Func = &Obj::objFunc(shared_ptr<const Variant>&)
  ...
  [[nodiscard]] std::shared_ptr<const UnphasedPopulation> setUnion(std::shared_ptr<const UnphasedPopulation> union_population) const;
  ...
  [[nodiscard]]  std::shared_ptr<const UnphasedPopulation> setIntersection(std::shared_ptr<const UnphasedPopulation> intersection_population) const;
  ...
  [[nodiscard]] std::shared_ptr<const UnphasedPopulation> setComplement(std::shared_ptr<const UnphasedPopulation> complement_population) const;
...
// Processes all variants in the population with class Obj and Func = &(bool Obj::objFunc(shared_ptr<const Variant>&))
