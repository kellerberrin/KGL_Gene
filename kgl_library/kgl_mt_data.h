...
using NumpyArray = NumpyContigMT<X86CountLock, ReadCountColumns>; // Use fast asm lock and standard columns.
using LocalArray = LocalContigMT<X86CountLock, ReadCountColumns>; // Use fast asm lock and standard columns.
