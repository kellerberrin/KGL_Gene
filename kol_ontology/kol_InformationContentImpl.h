...
class InformationContentImpl : public InformationInterface {
...
public:
  ...
  */
  ...
  [[nodiscard]] double sharedInformation(const std::string& go_termA, const std::string& go_termB) const override {


    return sharedInformation(go_termA, go_termB, *graph_ptr_);
