...
double kol::TermInformationContentImpl::getRootCount(const std::string& root_id) const {
...
*/
void kol::TermInformationContentImpl::convertProbtoIC() {
...
bool kol::TermInformationContentImpl::validateTerms(const std::string &id_termA, const std::string &id_termB) const {
...
/*!
  This method searches the sets to determine the most informative ancestor.
*/
double kol::TermInformationContentImpl::getEfficientMICA( const OntologySetType<std::string> &smaller_set,
...
double kol::TermInformationContentImpl::getMaxInformation(GO::Ontology ontology) const {
