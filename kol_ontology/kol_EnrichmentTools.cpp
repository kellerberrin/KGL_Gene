...
*/
kol::OntologySetType<std::string> kol::EnrichmentTools::getDescendantGenes( const GoGraphImpl &go,
...
*/
double kol::EnrichmentTools::enrichmentSignificance( const GoGraphImpl &go,
                                                     const TermAnnotation &data,
