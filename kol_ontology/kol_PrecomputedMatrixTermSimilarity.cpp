...
*/
double kol::PrecomputedMatrixTermSimilarity::calculateTermSimilarity(const std::string &goTermA, const std::string &goTermB) const {
...
*/
std::vector<double> kol::PrecomputedMatrixTermSimilarity::projectTermSet(const std::vector<std::string> &terms) const {
...
void kol::PrecomputedMatrixTermSimilarity::readSimilarityMatrix(const std::string &matrix_file) {
...
bool kol::PrecomputedMatrixTermSimilarity::isFileGood(const std::string &filename) const {
