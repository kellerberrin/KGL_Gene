...
private:
  ...
  void getMatrixAnalysis() {
    ...
    matrix_similarity_ptr_ = std::make_shared<const SimilarityMatrix>(UnitTestDefinitions::matrixFileNameCC());
...
BOOST_FIXTURE_TEST_SUITE(TestMatrix_RES_CCSuite, kol::TestMatrix_RES_CC)
