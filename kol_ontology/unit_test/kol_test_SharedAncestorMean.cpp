...
struct AncestorMeanSharedValues {
  ...
  const static constexpr double TEST_SHARED_INFORMATION_DEEP_TERMS_BP{4.1476397110223413};
  const static constexpr double TEST_SHARED_INFORMATION_CC_REFLEXIVE_SIM{3.7200115021244788};
  ...
  const static constexpr double TEST_SHARED_INFORMATION_MF{2.2817443779638995};
