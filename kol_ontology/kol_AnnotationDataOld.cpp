...
#include "kol_AnnotationDataOld.h"
...
*/
void kol::AnnotationDataOld::addAssociation(const std::string &gene, const std::string &goTerm, const std::string &evidenceCode) {
...
*/
std::vector<std::string> kol::AnnotationDataOld::getGoTermsForGene(const std::string &gene) const {
...
*/
kol::OntologySetType<std::string> kol::AnnotationDataOld::getGoTermsForGeneByOntology(const std::string &gene, GO::Ontology filterOntology, const GoGraph &G) const {
...
*/
std::vector<std::string> kol::AnnotationDataOld::getGoTermsEvidenceForGene(const std::string &gene) const {
...
*/
std::vector<std::string> kol::AnnotationDataOld::getGenesForGoTerm(const std::string &goTerm) const {
  //temparary storage variable
...
*/
void kol::AnnotationDataOld::addGenesForGoTerm(const std::string &goTerm, OntologySetType<std::string> &geneSet) const {
  //test if gene exists,prevent key error
  if (hasGoTerm(goTerm)) {
...
*/
std::vector<std::string> kol::AnnotationDataOld::getGenesEvidenceForGoTerm(const std::string &goTerm) const {
...
*/
size_t kol::AnnotationDataOld::getNumAnnotationsForGoTerm(const std::string &goTerm) const {
...
*/
size_t kol::AnnotationDataOld::getNumAnnotationsForGene(const std::string &gene) const {
...
std::vector<std::string> kol::AnnotationDataOld::getOntologyTerms(const GoGraph &graph, GO::Ontology ontology) const {
