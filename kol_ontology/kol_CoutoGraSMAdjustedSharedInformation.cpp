...
kol::OntologySetType<std::string> kol::CoutoGraSMAdjustedSharedInformation::getCommonDisjointAncestors( const std::string &termC1,
...
*/
bool kol::CoutoGraSMAdjustedSharedInformation::isDisjoint( const std::string &termC,
...
*/
size_t kol::CoutoGraSMAdjustedSharedInformation::getNumPaths( const std::string &termA,
...
*/
double kol::CoutoGraSMAdjustedSharedInformation::sharedInformation(const std::string &termA,
                                                                   const std::string &termB) const {
...
*/
double kol::CoutoGraSMAdjustedSharedInformation::termInformation(const std::string &term) const {
  // return 0 for any terms not in the datbase
...
*/
std::size_t kol::CoutoGraSMAdjustedSharedInformation::pathCount(const std::string &termA, const std::string &termB) const {
...
*/
void kol::CoutoGraSMAdjustedSharedInformation::visitHelper( const GoGraph::GoVertex &v,
...
*/
std::string kol::CoutoGraSMAdjustedSharedInformation::keyPair(const std::string &termA, const std::string &termB) const {
...
A private function to test if the key as been seen already.
*/
bool kol::CoutoGraSMAdjustedSharedInformation::hasSeenKey(const std::string &key) const {
