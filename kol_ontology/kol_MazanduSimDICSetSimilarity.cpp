...
double kol::MazanduSimDICSetSimilarity::calculateSimilarity(const OntologySetType<std::string> &row_terms,
...
double kol::MazanduSimDICSetSimilarity::calcICSum(const OntologySetType<std::string> &terms) const {
