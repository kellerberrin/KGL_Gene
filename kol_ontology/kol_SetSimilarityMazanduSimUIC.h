...
==============================================================================*/
#ifndef KOL_MAZANDU_SIMUIC_SET_SIMILARITY
#define KOL_MAZANDU_SIMUIC_SET_SIMILARITY
...
/*! \class SetSimilarityMazanduSimUIC
...
*/
class SetSimilarityMazanduSimUIC : public SetSimilarityInterface {

public:
  //! Constructor
  /*!
  Creates the SetSimilarityMazanduSimUIC class assigning the GoGraph private memeber.
  */
  ...
  ~SetSimilarityMazanduSimUIC() override = default;
