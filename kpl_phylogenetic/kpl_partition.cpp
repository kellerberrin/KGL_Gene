...
kpl::Partition::Partition() {
  //std::cout << "Constructing a Partition" << std::endl;
  clear();
}


void kpl::Partition::clear() {
...
unsigned kpl::Partition::getNumSites() const {
...
unsigned kpl::Partition::getNumSubsets() const {
...
std::string kpl::Partition::getSubsetName(unsigned subset) const {
...
const kpl::Partition::partition_t& kpl::Partition::getSubsetRangeVect() const {
...
kpl::DataType kpl::Partition::getDataTypeForSubset(unsigned subset_index) const {
...
const std::vector<kpl::DataType>& kpl::Partition::getSubsetDataTypes() const {
...
unsigned kpl::Partition::findSubsetByName(const std::string & subset_name) const {
...
unsigned kpl::Partition::findSubsetForSite(unsigned site_index) const {
...
bool kpl::Partition::siteInSubset(unsigned site_index, unsigned subset_index) const {
...
unsigned kpl::Partition::numSitesInSubset(unsigned subset_index) const {
...
std::vector<unsigned> kpl::Partition::calcSubsetSizes() const {
...
void kpl::Partition::parseSubsetDefinition(std::string & s) {
...
void kpl::Partition::addSubset(unsigned subset_index, std::string subset_definition) {
...
void kpl::Partition::addSubsetRange(unsigned subset_index, std::string range_definition) {
...
int kpl::Partition::extractIntFromRegexMatch(regex_match_t s, unsigned min_value) {
...
void kpl::Partition::finalize(unsigned nsites) {
...
void kpl::Partition::defaultPartition(unsigned nsites) {
  clear();
  _num_sites = nsites;
  _num_subsets = 1;
