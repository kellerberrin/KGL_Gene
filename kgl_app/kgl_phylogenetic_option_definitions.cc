...
{ TSS_FILE_, OptionOptional::OPTIONAL, OptionArrayType::SINGULAR, OptionArgumentType::FILE_NAME, "tss.gff",
R"("This GFF file contains the offsets for the Translation Start Sequences (TSS) in the Genome of Plasmodium Falciparum")"},
