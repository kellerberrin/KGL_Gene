...
void kol::TermSimilarityWriter::writeSimilarityMatrix( const std::shared_ptr<const TermSimilarityInterface> &termSim,
...
void kol::TermSimilarityWriter::writeMatrix( const std::string &fname,
