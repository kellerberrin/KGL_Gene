...
public:
	//! Constructor
	/*!
	Creates the MazanduSimGICSetSimilarity class assigning the GoGraph private memeber.
	*/
	inline MazanduSimDICSetSimilarity(GoGraph* graph, const TermInformationContentMap &icMap){
		_graph = graph;
		_icMap = icMap;
	}
