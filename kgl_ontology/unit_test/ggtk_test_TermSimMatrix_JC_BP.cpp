...
private:
  ...
  void getMatrixAnalysis() {
    ...
    matrix_similarity_ptr_ = std::make_shared<const PrecomputedMatrixTermSimilarity>(UnitTestDefinitions::matrixFileNameBP());
...
BOOST_FIXTURE_TEST_SUITE(TestMatrix_JC_BP_Suite, TestMatrix_JC_BP)
