...
kga::InbreedingCalculation::processLogLikelihood(const GenomeId_t& genome_id,
  ...
  do {
    ...
    if (not Optimize::returnSuccess(result_code)) {
      ...
      ExecEnv::log().error("InbreedingAnalysis::processLogLikelihood; Genome: {}, loglikelihood: {}, Max at kga_inbreed: {}, initial kga_inbreed: {}, calc kga_inbreed: {}, optimizer result: {}, iterations: {}",
