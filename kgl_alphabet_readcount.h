...
#ifndef KGL_ALPHABET_READCOUNT_H
#define KGL_ALPHABET_READCOUNT_H
...
// Implement the read count NUCLEOTIDE_COLUMNS as "A", "C", "G", "T"/"U", "-", "E", "F", "I", "J" "K" in that order.
// Note that "E" = +A , "F" = +C , "I" = +G, "J" = +T/U and "K" = +N.


class ReadCountColumns  {

public:


  ReadCountColumns() = delete; // Singleton
  ...
  static DNA5::Alphabet extendToBase(Alphabet nucleotide) {
    ...
    switch (nucleotide) {
      ...
      default:
        ExecEnv::log().error("ReadCountColumns::extendToBase, attempt to convert non-base nucleotide",
  ...
  // Insert offsets. Translates to an insert nucleotide.
  static DNA5::Alphabet baseNucleotide(Alphabet nucleotide) {

    // Translate the nucleotide to an array column
    switch (nucleotide) {

      case Alphabet::E: return DNA5::Alphabet::A;
      case Alphabet::F: return DNA5::Alphabet::C;
      case Alphabet::I: return DNA5::Alphabet::G;
      case Alphabet::J: return DNA5::Alphabet::T;
      case Alphabet::K: return DNA5::Alphabet::N;

      default:
        break;
    }

    ExecEnv::log().error("ReadCountColumns::baseNucleotide(), Invalid DNA5 base Nucleotide: {}", convertToChar(nucleotide));
    return DNA5::Alphabet::N; // Dummy value
...
#endif //KGL_ALPHABET_READCOUNT_H
