...
#ifndef KGL_kgl_resource_citation_H
#define KGL_kgl_resource_citation_H
...
/// Factory for allele citation resources (citationFile).
class CitationResourceFactory : public ResourceFactory {
...
#endif //KGL_kgl_resource_citation_H
