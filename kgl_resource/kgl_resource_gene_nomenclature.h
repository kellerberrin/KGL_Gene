...
#ifndef KGL_kgl_resource_gene_nomenclature_H
#define KGL_kgl_resource_gene_nomenclature_H
...
/// Factory for gene nomenclature resources. The resourceIdent selects the parser: UniprotID -> UniprotResource, EnsemblHGNC -> EnsemblHGNCResource.
class GeneNomenclatureFactory : public ResourceFactory {
...
#endif //KGL_kgl_resource_gene_nomenclature_H
