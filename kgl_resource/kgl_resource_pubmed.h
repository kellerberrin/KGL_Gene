...
#ifndef KGL_kgl_resource_pubmed_H
#define KGL_kgl_resource_pubmed_H
...
/// Factory for PubMed API resources (pubmedPublicationCache, pubmedCitationCache).
class PubmedResourceFactory : public ResourceFactory {
...
#endif //KGL_kgl_resource_pubmed_H
