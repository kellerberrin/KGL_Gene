...
#ifndef KGL_kgl_resource_genealogy_H
#define KGL_kgl_resource_genealogy_H
...
/// Factory for human genome genealogy resources (genealogyFile).
class GenealogyResourceFactory : public ResourceFactory {
...
#endif //KGL_kgl_resource_genealogy_H
