...
#ifndef KGL_kgl_resource_entrez_H
#define KGL_kgl_resource_entrez_H
...
/// Factory for Entrez gene resources (entrezFile).
class EntrezResourceFactory : public ResourceFactory {
...
#endif //KGL_kgl_resource_entrez_H
