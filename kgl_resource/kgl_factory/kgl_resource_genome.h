...
#ifndef KGL_kgl_resource_genome_H
#define KGL_kgl_resource_genome_H
...
/// Factory for genome database resources (fastaFile, gffFile, translationTable, optional gafFile).
class GenomeResourceFactory : public ResourceFactory {
...
#endif //KGL_kgl_resource_genome_H
