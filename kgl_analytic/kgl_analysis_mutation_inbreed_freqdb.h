...
// is looked up. So for Gnomad 2.1 (and 3.1) "EAS" is translated internally to "AF_eas" and the variant frequency is
// looked up from the variant database (parsed and held in memory).
//
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
  ...
  [[nodiscard]] std::optional<double> processFloatField( const Variant& variant,
...
private:
  ...
  constexpr static const SuperPopPair SUPER_POP_AFR_GNOMAD_3_1 {SUPER_POP_AFR_, "AF_afr"} ;  // African
  constexpr static const SuperPopPair SUPER_POP_AMR_GNOMAD_3_1 {SUPER_POP_AMR_, "AF_amr"};  // American
  constexpr static const SuperPopPair SUPER_POP_EAS_GNOMAD_3_1 {SUPER_POP_EAS_, "AF_eas"};  // East Asian
  constexpr static const SuperPopPair SUPER_POP_EUR_GNOMAD_3_1 {SUPER_POP_EUR_, "AF_nfe"};  // European
  constexpr static const SuperPopPair SUPER_POP_SAS_GNOMAD_3_1 {SUPER_POP_SAS_, "AF_sas"};  // South Asian
  ...
  constexpr static const SuperPopPair SUPER_POP_AFR_1000 {SUPER_POP_AFR_, "AF_afr"} ;  // African
  constexpr static const SuperPopPair SUPER_POP_AMR_1000 {SUPER_POP_AMR_, "AF_amr"};  // American
  constexpr static const SuperPopPair SUPER_POP_EAS_1000 {SUPER_POP_EAS_, "AF_eas"};  // East Asian
  constexpr static const SuperPopPair SUPER_POP_EUR_1000 {SUPER_POP_EUR_, "AF_nfe"};  // European
  constexpr static const SuperPopPair SUPER_POP_SAS_1000 {SUPER_POP_SAS_, "AF_sas"};  // South Asian
