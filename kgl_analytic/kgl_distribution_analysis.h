...
public:
  ...
  [[nodiscard]] bool writeDistribution( std::shared_ptr<const GenomeReference> genome_db,
...
private:
  ...
  [[nodiscard]] bool writeData( std::shared_ptr<const GenomeReference> genome_db,
                                size_t interval_size,
                                const ContigId_t analysis_contig,
                                ContigOffset_t start_offset,
                                ContigOffset_t end_offset,
