...
//    publication_ptr->extendedBiblio(out_str);
    ExecEnv::log().info("\n{}", out_str.str());
...
void kgl::NullAnalysis::ensemblIdIndex(const std::shared_ptr<const PopulationDB>& population) {
  ...
  const std::vector<std::string> LILRB1_ensembl_symbol = {
      ...
      "ENSG00000276433", //	KIR3DL3	killer cell immunoglobulin like receptor%2C three Ig domains and long cytoplasmic tail_ 3
      "ENSG00000273947", //	KIR2DL3	killer cell immunoglobulin like receptor%2C two Ig domains and long cytoplasmic tail_ 3
      "ENSG00000276820", //	KIR2DL1	killer cell immunoglobulin like receptor%2C two Ig domains and long cytoplasmic tail_ 1
      "ENSG00000276779", //	KIR2DL4	killer cell immunoglobulin like receptor%2C two Ig domains and long cytoplasmic tail_ 4
      "ENSG00000273775", //	KIR3DL1	killer cell immunoglobulin like receptor%2C three Ig domains and long cytoplasmic tail_ 1
      "ENSG00000274324", //	KIR2DS4	killer cell immunoglobulin like receptor%2C two Ig domains and short cytoplasmic tail_ 4
      "ENSG00000273735"	// KIR3DL2	killer cell immunoglobulin like receptor%2C three Ig domains and long cytoplasmic tail_ 2
