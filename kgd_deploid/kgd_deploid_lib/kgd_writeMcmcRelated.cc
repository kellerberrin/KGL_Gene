...
void DEploidIO::writeMcmcRelated (std::shared_ptr<McmcSample> mcmcSample, bool useIBD){
...
void DEploidIO::writeProp(std::shared_ptr<McmcSample> mcmcSample, bool useIBD){
    if ( useIBD ){
...
void DEploidIO::writeLLK(std::shared_ptr<McmcSample> mcmcSample, bool useIBD){
    if ( useIBD ){
...
void DEploidIO::writeHap(std::shared_ptr<McmcSample> mcmcSample, bool useIBD){
    if ( useIBD ){
...
void DEploidIO::writeVcf(std::shared_ptr<McmcSample> mcmcSample ){
    ...
    (*writeTo) << kgl::ExecEnv::commandLine() << endl;
